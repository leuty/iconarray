"""icon-timeseries documentation build configuration file.
...
project = "ICON time series"
copyright = "2022, Claire Merker"  # pylint: disable=W0622  # redefined-builtin
author = "Claire Merker"
...
version = icon_timeseries.__version__
# The full version, including alpha/beta/rc tags.
release = icon_timeseries.__version__
...
htmlhelp_basename = "icon-timeseriesdoc"
...
man_pages = [
    (
        master_doc,
        "icon-timeseries",
        "ICON time series Documentation",
        [author],
        1,
    )
]
